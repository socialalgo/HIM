...
if __name__ == '__main__':
    ...
    parser.add_argument('--expid', type=str, default='FinalNet_default', help='The experiment id to run.')
    ...
    model.load_weights("checkpoints/twitter_data_train/FinalNet_default.model")
    # model.load_weights("checkpoints/tencent_train/FinalNet_default.model")
